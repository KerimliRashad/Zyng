...
pyinstaller --noconfirm --onefile --windowed --name "JeffTUN" --icon "icon.ico" --collect-all customtkinter --add-binary "xray.exe;." --add-data "logo_white.png;." --add-data "icon.ico;." qipcall.py
